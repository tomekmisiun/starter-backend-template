...
|---|------|----------|--------|------|-----|--------|
| 1 | **Legacy route production gate** — `LEGACY_ROUTES_ENABLED` env (default off in production); tests + deprecation doc update | TD-002 | S | Low | Very High | Not started |
| 2 | **Worker processing-queue recovery** — reaper or visibility timeout for `app_jobs_processing` | TD-003 | M | Medium | Very High | Not started |
